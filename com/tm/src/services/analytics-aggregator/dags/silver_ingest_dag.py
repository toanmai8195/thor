...
with DAG(
    ...
    description="payments_bronze → silver_events mỗi 5 phút (dbt incremental append)",
    ...
    # Airflow mount /opt/analytics → dbt_clickhouse nằm ở /opt/analytics/dbt_clickhouse
    # =========================================================================
